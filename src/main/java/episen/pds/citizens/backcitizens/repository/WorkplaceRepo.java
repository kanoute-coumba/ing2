...
public interface WorkplaceRepo extends CrudRepository<Workplace, Integer> {
    @Query(value = "select workplace.id_workplace, space.id_space, space.type_space, space.id_floor, a1.name_floor, a1.id_building, " +
            "a1.name_building from space inner join workplace on workplace.id_space=space.id_space inner join " +
